...
const schedule = {
  'Понедельник': [
    { subject: 'Физкультура', time: '13:10-13:50' },
    { subject: 'Алгебра', time: '13:55-14:35' },
    { subject: 'Узбекский язык', time: '14:40-15:20' },
    { subject: 'Химия', time: '15:25-16:05' },
    { subject: 'Английский язык', time: '16:10-16:50' },
    { subject: 'Классный час', time: '16:55-17:35' }
  ],
  'Вторник': [
    { subject: 'География', time: '12:30-13:05' },
    { subject: 'ОГП', time: '13:10-13:50' },
    { subject: 'Биология', time: '13:55-14:35' },
    { subject: 'Информатика', time: '14:40-15:20' },
    { subject: 'Геометрия', time: '15:25-16:05' }
  ],
  'Среда': [
    { subject: 'Физкультура', time: '13:10-13:50' },
    { subject: 'Алгебра', time: '13:55-14:35' },
    { subject: 'Узбекский язык', time: '14:40-15:20' },
    { subject: 'Русский язык', time: '15:25-16:05' },
    { subject: 'Английский язык', time: '16:10-16:50' },
    { subject: 'Геометрия', time: '16:55-17:35' }
  ],
  'Четверг': [
    { subject: 'Химия', time: '12:30-13:05' },
    { subject: 'Технология', time: '13:10-13:50' },
    { subject: 'История Узбекистана', time: '13:55-14:35' },
    { subject: 'Литература', time: '14:40-15:20' },
    { subject: 'Физика', time: '15:25-16:05' },
    { subject: 'Английский язык', time: '16:10-16:50' }
  ],
  'Пятница': [
    { subject: 'Узбекский язык', time: '12:30-13:05' },
    { subject: 'Физика', time: '13:10-13:50' },
    { subject: 'Русский язык', time: '13:55-14:35' },
    { subject: 'Всемирная история', time: '14:40-15:20' },
    { subject: 'Литература', time: '15:25-16:05' },
    { subject: 'Воспитание', time: '16:10-16:50' }
  ],
  'Суббота': [
    { subject: 'Биология', time: '13:55-14:35' },
    { subject: 'География', time: '14:40-15:20' },
    { subject: 'История Узбекистана', time: '15:25-16:05' },
    { subject: 'Алгебра', time: '16:10-16:50' },
    { subject: 'Черчение', time: '16:55-17:35' }
  ],
  'Воскресенье': []
};
...
function formatScheduleMessage(dayInfo) {
  ...
  if (lessons.length === 0) {
    ...
    lessons.forEach((lesson, index) => {
      message += `${index + 1}. <b>${lesson.subject}</b> <i>(${lesson.time})</i>\n`;
    });
  }
